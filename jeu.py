            ...
            if event.type==QUIT: encoure=False #si il y a un événement QUITTER , encoure est faux
                ...
                for k in p1keys: #boucle qui renvoie toutes les keys de p1keys dans k
                    if event.key==k: #si la touche appuyée est égale à k
                        ...
                        if di==0: prs[pp].bouger("Up") #si di est égal à 0 , alors le personnage va bouger vers le haut
                        elif di==1: prs[pp].bouger("Down") #si di est égal à 1 , alors le personnage va bouger vers le bas
                        elif di==2: prs[pp].bouger("Left") #si di est égal à 2 , alors le personnage va bouger vers la gauche
                        elif di==3: prs[pp].bouger("Right") #si di est égal à 3 , alors le personnage va bouger vers la droite
                        elif di==4: prs[pp].bouger("Att1") #si di est égal à 4 , alors le personnage va attaquer avec l'attaque 1
                        elif di==5: prs[pp].bouger("Att2") #si di est égal à 5 , alors le personnage va attaquer avec l'attaque 2
                        elif di==6: prs[pp].bouger("Att3") #si di est égal à 6 , alors le personnage va attaquer avec l'attaque 3
                        elif di==7: prs[pp].bouger("Defence") #si di est égal à 7 , alors le personnage va se défendre

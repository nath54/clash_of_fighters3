...
def aff_menu(p1,p2,p3,p4,fps):
    ...
    texte("move up",150,350,15,(0,0,0))
    texte("move down",150,365,15,(0,0,0))
    texte("move left",150,380,15,(0,0,0))
    texte("move right",150,395,15,(0,0,0))
    texte("att 1",150,410,15,(0,0,0))
    texte("att 2",150,425,15,(0,0,0))
    texte("att special",150,440,15,(0,0,0))
    texte("defence",150,455,15,(0,0,0))
    #player 1
